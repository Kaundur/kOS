...
all: clean
	...
	i686-elf-gcc -c $(ARCHDIR)/keyboard.c -o $(ARCHDIR)/keyboard.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
	...
	i686-elf-gcc -T $(ARCHDIR)/linker.ld -o $(ARCHDIR)/kOS.bin -ffreestanding -O2 -nostdlib $(ARCHDIR)/boot.o $(ARCHDIR)/kernel.o $(ARCHDIR)/tty.o $(ARCHDIR)/keyboard.o -lgcc
